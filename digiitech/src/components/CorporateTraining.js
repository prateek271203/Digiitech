import '../components/Styling/CorporateTraining.css';
    ...
    <div className="corporate-training" id='corpTraining'>
      <nav className="navbar fixed-top navbar-light bg-light">
        ...
        <div className="navbar-nav">
          <a className="nav-item nav-link active" href="/"><i className="bi bi-envelope-fill" style={{margin:'8px'}}></i>digiitech@gmail.com<span className="sr-only">(current)</span></a>
          <a className="nav-item nav-link active" href="/"><i className="bi bi-telephone-fill" style={{margin:'8px'}}></i>9876543219 </a>
        </div>
      </nav>
