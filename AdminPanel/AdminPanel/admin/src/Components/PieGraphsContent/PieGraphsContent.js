...
import { Typography, Grid, FormControl, Card, CardContent, Select, MenuItem } from '@material-ui/core';
    ...
    const pieChartData = {
        ...
        country: {
          ...
          datasets: [
            {
              data: [10, 25, 30, 20, 15],
              backgroundColor: ['#8D437A', '#DC63BE', '#EFF4FB', '#A8D0CE', '#FFD700'],
            },
          ],
        },
      };
              ...
              generateLabels: function (chart) {
                ...
                if (data.labels.length && data.datasets.length) {
                  return data.labels.reduce((labels, label, i) => {
                    ...
                    const percentage = ((value / ds.data.reduce((a, b) => a + b, 0)) * 100);
                    ...
                    <Card className={styles.chartCard}>
                      <CardContent>
                        <Typography variant="h6" className={styles.chartTitle}>
                          {index === 0 ? 'Total Users' : index === 1 ? 'Teachers' : 'Courses'}
                        </Typography>
                        <div className = {styles.dropdownContainer}>
                          <FormControl variant="outlined" className={styles.chartFilter}>
                            <Select
